...
//    NSLog(@"gInterface->GetMsTime():%lu,gSavaTime+gTimeout:%lu,gSavaTime:%lu,gTimeout:%lu",gInterface->GetMsTime(),gSaveTime + gTimeOut ,gSaveTime,gTimeOut);
	if(gInterface
...
//    NSString *amountStr = [NSString stringWithCString:amount encoding:NSUTF8StringEncoding];
//    NSString *tStr = [NSString stringWithCString:t encoding:NSUTF8StringEncoding];
//    NSString *resultStr = [NSString stringWithFormat:@"%@%@",amountStr,tStr];
//    NSLog(@"%@",resultStr);
////    gInputParam = resultStr.UTF8String;
//    strncpy((char*)gInputParam, resultStr.UTF8String, resultStr.length);
