...
//        NSString *yuliushoujihao = [[NSUserDefaults standardUserDefaults] objectForKey:Kcitiaoyuliushoujihao];
        ...
        NSDictionary *citiaoDict = [KUserDefault objectForKey:KcitiaoInfo];
        NSArray *citiaoArr = [citiaoDict objectForKey:shenfenzhenghao];
        NSString *name = citiaoArr[0];
        NSString *yuliushoujihao = citiaoArr[1];
        
        NSString *validType = @"3";
        NSString *agentID = @"500200000001";
        ...
        NSString *urlStr = [NSString stringWithFormat:@"http://%@:%@/MposApp/appToWebToPeripheral.action?",kCiTiaoKaIP,kCiTiaoKaPort];
