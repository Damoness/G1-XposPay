...
#warning 轮播图
//   _lunboView = [[LunBoView alloc] initWithFrame:self.scrollView.bounds];
//    _lunboView = [[LunBoView alloc] initWithFrame:CGRectMake(0, 44, self.view.frame.size.width, CGRectGetHeight(self.scrollView.frame))];
//    NSArray *arr = @[@"banner_2",@"home_banner_2",@"home_banner_3",@"home_banner_4",@"home_banner_5",@"home_banner_6" ];
//    [_lunboView setViewWithArray:arr type:nil];
