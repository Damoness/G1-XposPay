...
- (void)viewDidLoad {
    ...
    // Do any additional setup after loading the view.
     //  int i =  self.view1.frame.size.height;
    
    
    _lunboView = [[LunBoView alloc] initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, 109)];
    NSArray *arr = @[@"banner2",@"banner3",@"banner4",@"banner5",@"banner6"];
...
-(void)_initSubViews{
    ...
    NSArray *imgArray = @[@"话费充值.png",@"机票服务",@"游戏点卡",@"基金理财",@"信用卡还款",@"余额查询",@"卡卡转账",@"交通违章",@"水电煤代缴"];
